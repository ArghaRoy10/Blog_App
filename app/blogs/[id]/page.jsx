...
const page = ({params}) => {
  ...
  return (data ? <>
    ...
    <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
      ...
      <h3 className='my-8 text-[18px] font-semibold'>Step 1: Self-Reflection and Goal Setting</h3>
      ...
      <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of what you want to achieve. Start by reflecting on your values, aspirations and long-term goals.</p>
      <h3 className='my-8 text-[18px] font-semibold'>Step 2: Self-Reflection and Goal Setting</h3>
      <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of what you want to achieve. Start by reflecting on your values, aspirations and long-term goals.</p>
      <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of what you want to achieve. Start by reflecting on your values, aspirations and long-term goals.</p>
      <h3 className='my-8 text-[18px] font-semibold'>Step 3: Self-Reflection and Goal Setting</h3>
      <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of what you want to achieve. Start by reflecting on your values, aspirations and long-term goals.</p>
      <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of what you want to achieve. Start by reflecting on your values, aspirations and long-term goals.</p>
      <h3 className='my-8 text-[18px] font-semibold'>Conclusion</h3>
