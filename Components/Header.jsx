  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-8'>
            ...
            <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>A blog is an online platform for sharing information and opinions on various topics through regularly updated posts.</p>
